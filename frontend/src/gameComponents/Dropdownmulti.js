...
const Dropdownmulti = () => {
    ...
    return <AsyncSelect className="dropdown_class1" role="submit" aria-label="dropdown1" id="dropdown_class1" placeholder={<div>Know the song? Search for the artist/title</div>} loadOptions={loadOptions} onChange={handleChange} />
